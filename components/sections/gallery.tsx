...
const galleryItems = [
  { image: "/mobile-background/lover (3).webp", text: " " },
  { image: "/mobile-background/lover (2).webp", text: " " },
  { image: "/mobile-background/lover (1).webp", text: " " },
  { image: "/mobile-background/lover (4).webp", text: " " },
  { image: "/mobile-background/lover (5).webp", text: " " },
